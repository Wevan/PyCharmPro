...
def createExcel():
    ...
    sheet1 = w.add_sheet('blank_problem')
    row0 = [u'analysis', u'answer', u'chapter', u'content', u'course', u'pronum', u'tips', u'orderd']
    # 生成第一行
    for i in range(0, len(row0)):
        sheet1.write(0, i, row0[i])
    sheet2 = w.add_sheet('choice_problem')
    row0 = [u'analysis', u'answer', u'chapter', u'content', u'course', u'pronum', u'tips', u'sectiona', u'sectionb',
            u'sectionc', u'sectiond']
    for i in range(0, len(row0)):
        sheet2.write(0, i, row0[i])
    sheet3 = w.add_sheet('code_bl_problem')
    row0 = [u'analysis', u'answer', u'chapter', u'content', u'course', u'pronum', u'tips']
    for i in range(0, len(row0)):
        sheet3.write(0, i, row0[i])
    sheet4 = w.add_sheet('code_problem')
    row0 = [u'analysis', u'answer', u'chapter', u'content', u'course', u'pronum', u'tips']
    for i in range(0, len(row0)):
        sheet4.write(0, i, row0[i])
    sheet5 = w.add_sheet('shr_ans_problem')
    row0 = [u'analysis', u'answer', u'chapter', u'content', u'course', u'pronum', u'tips']
    for i in range(0, len(row0)):
        ...
        for nrows_one in range(1, int(sheet1.nrows)):
            ...
            for s in range(0, int(sheet1.ncols)):
                try:
                    ...
                    if sheet1.cell_value(0, s) == "pronum":
                        try:
